...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-3 left-3 right-3 z-50 rounded-full border border-foreground/5 bg-background/80 px-3 py-2 shadow-lg backdrop-blur-xl md:hidden">
