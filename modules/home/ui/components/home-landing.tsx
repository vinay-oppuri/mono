import BlocksBackground from "@/components/3js-blocks";
  ...
  return (
    ...
    <BlocksBackground />
      <main className="relative z-10">
        {/* Hero */}
        <section className="min-h-screen flex flex-col items-start justify-center px-4 text-center mx-auto w-full max-w-6xl">
          <div className="max-w-3xl text-center md:text-left pl-0 md:pl-36">
            ...
            <p className="max-w-xl text-sm md:text-base text-center md:text-left text-muted-foreground leading-relaxed mb-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
              <Link
                href="/sign-up"
                className="h-10 w-[80%] md:w-fit px-8 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground text-xs md:text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300 shadow-md shadow-primary/40"
              >
                Build First Agent
